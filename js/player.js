...
class Player {
    ...
    hits(block) {
        //console.log(collideRectRect(this.x - 10, this.y, this.r, this.r, block.x, block.y - 10, block.r, block.r));
        return collideRectRect(this.x - 10, this.y, this.r, this.r, block.x, block.y - 10, block.r, block.r);
    }
